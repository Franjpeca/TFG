...
def create_pipeline(**kwargs) -> Pipeline:
    ...
    visualize_only = params.get("visualize_only", [])
    ...
    # Aceptar visualize_only como string o lista
    if isinstance(visualize_only, str):
    ...
    if not subpipelines:
        logger.info(
            "No se procesaron subpipelines de visualización: no se hallaron métricas esperadas."
        )
        return Pipeline([])

    # Sumar todos los mini-pipelines
