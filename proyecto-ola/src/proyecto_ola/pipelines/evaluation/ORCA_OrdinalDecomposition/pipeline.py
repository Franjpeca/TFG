...
from .nodes import Predict_ORCA_OrdinalDecomposition, Evaluate_ORCA_OrdinalDecomposition
...
def create_pipeline(
    ...
    wrapped_predict = make_predict_wrapper(
        Predict_ORCA_OrdinalDecomposition, param_key, dataset_id
    )
    wrapped_evaluate = make_evaluate_wrapper(
        Evaluate_ORCA_OrdinalDecomposition, param_key, model_type, dataset_id
    )
