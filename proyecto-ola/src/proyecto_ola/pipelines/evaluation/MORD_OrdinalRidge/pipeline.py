...
from .nodes import Predict_MORD_OrdinalRidge, Evaluate_MORD_OrdinalRidge
...
def create_pipeline(param_key: str,
    ...
    wrapped_predict = partial(
        Predict_MORD_OrdinalRidge,
        model_id=param_key,
        dataset_id=dataset_id,
    )
    wrapped_predict = update_wrapper(wrapped_predict, Predict_MORD_OrdinalRidge)
    ...
    wrapped_evaluate = update_wrapper(wrapped_evaluate, Evaluate_MORD_OrdinalRidge)
