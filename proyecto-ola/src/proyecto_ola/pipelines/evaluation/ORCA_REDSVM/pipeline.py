...
from .nodes import Predict_ORCA_REDSVM, Evaluate_ORCA_REDSVM
...
def create_pipeline(param_key: str,
    ...
    wrapped_predict = update_wrapper(wrapped_predict, Predict_ORCA_REDSVM)

    wrapped_evaluate = partial(
        Evaluate_ORCA_REDSVM,
        model_id=param_key,
        model_type=model_type,
        dataset_id=dataset_id,
    )
    wrapped_evaluate = update_wrapper(wrapped_evaluate, Evaluate_ORCA_REDSVM)
