...
from .nodes import Predict_CLASSIC_LinearRegression, Evaluate_CLASSIC_LinearRegression
import re
...
def create_pipeline(
    ...
    wrapped_predict = make_predict_wrapper(
        Predict_CLASSIC_LinearRegression, param_key, dataset_id
    )
    wrapped_evaluate = make_evaluate_wrapper(
        Evaluate_CLASSIC_LinearRegression, param_key, model_type, dataset_id
    )
