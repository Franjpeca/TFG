...
from .nodes import Predict_MORD_LogisticIT, Evaluate_MORD_LogisticIT
...
def create_pipeline(param_key: str,
    ...
    wrapped_predict = partial(
        Predict_MORD_LogisticIT,
        model_id=param_key,
        dataset_id=dataset_id,
    )
    wrapped_predict = update_wrapper(wrapped_predict, Predict_MORD_LogisticIT)
    ...
    wrapped_evaluate = update_wrapper(wrapped_evaluate, Evaluate_MORD_LogisticIT)
