...
def Train_CLASSIC_LinearRegression(dataset, params, cv_settings, training_settings, model_id, dataset_id):
    ...
    logger.info(f"[Training] Entrenando LinearRegression con Cross-Validation (QWK) con el dataset: {dataset_id} ...\n")
    ...
    logger.info(f"[Training] Mejor QWK obtenido: {mean_score:.5f}")
